...
public class ReedsSheppCarPlanner extends AbstractMotionPlanner {
	...
	static {
        ...
        public static void initRSCP()
        {
//            PLANNING_ALGORITHM[0]=RRTConnect;
//            PLANNING_ALGORITHM[1]=RRTstar;
//            PLANNING_ALGORITHM[2]=TRRT;
//            PLANNING_ALGORITHM[3]=SST;
//            PLANNING_ALGORITHM[4]=LBTRRT;
//            PLANNING_ALGORITHM[5]=PRMstar;
//            PLANNING_ALGORITHM[6]=SPARS;
//            PLANNING_ALGORITHM[7]=pRRT;            PLANNING_ALGORITHM[8]=LazyRRT;
//
//
        INSTANCE = null;
        NativeLibrary.addSearchPath("simplereedssheppcarplanner", "SimpleReedsSheppCarPlanner");
...
//	path = null;
//	pathLength = null;
//	distanceBetweenPathPoints = 0.5;
//	turningRadius = 1.0;
//	planningTimeInSecs = 30.0;
//	collisionCircleCenters = null;
//	algo = PLANNING_ALGORITHM.RRTConnect;
